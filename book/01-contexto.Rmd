...
```{r, calendario, fig.pos="H", fig.cap="Representación de fechas de corte y fechas de pago", echo=FALSE, out.width="80%", fig.align="center"}
...
```{r, clasificacion, fig.pos="H", echo=FALSE, out.width="80%", fig.align="center", fig.cap="Clasificación de pagos"}
...
```{r, triangulo, out.width="80%", fig.pos="H", fig.cap="Triángulo", echo=FALSE, fig.cap="Triángulo de pagos", fig.align="center"}
creditos %>% 
