...
El entregable del proyecto consistía en un pipeline de datos para actualizar cada quincena los últimos movimientos de los clientes y producir predicciones. Con esto en mente, el plan de trabajo que los científicos de datos siguieron fue: 
...
3. **Model selection** se probaron distintos algoritmos de clasificación y se determinaron los mejores hiperparámetrosl.
